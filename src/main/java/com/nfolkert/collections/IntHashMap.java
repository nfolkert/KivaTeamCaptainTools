...
/**
 * Note: I took this from inside the jakart code (it was package visibility there).
 *
 *
...
public class IntHashMap {
    ...
    public IntHashMap(IntHashMap toCopy)
    {
        this(toCopy.table.length, toCopy.loadFactor);

        // this could be done more efficiently
        for (Entry entry : toCopy.table)
        {
            while ( entry != null )
            {
