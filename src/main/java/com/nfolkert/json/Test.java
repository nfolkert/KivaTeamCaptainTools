...
// Obj is a typical class that implements JSONString.        
        ...
        try {     	
            ...
            System.out.println(toStringForTest(j));
            ...
            final JSONArray arr = new JSONArray(jj.toString());
            ...
            System.out.println("");
            System.out.println(toStringForTest(a,4));
            System.out.println("");

            a = new JSONArray(" [\"<escape>\", next is an implied null , , ok,] ");
            System.out.println(toStringForTest(a));
            System.out.println("");
            ...
            System.out.println("\nwrite:");
            // System.out.println( j.toString() j.write(new StringWriter()));
    ...
    private static String toStringForTest(JSONObject j)
    ...
    private static String toStringForTest(JSONObject j, int indentFactor)
            throws JSONException
    {
        final StringBuilder sb = new StringBuilder();
        j.toString(indentFactor, sb);
        return sb.toString();
    }

    private static String toStringForTest(JSONArray j)
            throws JSONException
    {
        final StringBuilder sb = new StringBuilder();
        j.toString(0, sb);
    ...
    private static String toStringForTest(JSONArray j, int indentFactor)
            throws JSONException
    {
        final StringBuilder sb = new StringBuilder();
        j.toString(indentFactor, sb);
